...
#define HIMAX_DRIVER_VER "0.3.3.0_T89239_02"
...
//static int gest_width=0,gest_height=0,gest_mid_x=0,gest_mid_y=0;
	...
	enum gesture_event_type {
		EV_GESTURE_SWIPEUP = 0x01,	//swipe up
		EV_GESTURE_02,
		EV_GESTURE_03,
		EV_GESTURE_04,
		EV_GESTURE_C,		// C
		...
		EV_GESTURE_14,
		EV_GESTURE_15,
		EV_GESTURE_DBCLICK = 0x80,	// Double Click
	};

	#define KEY_CUST_DBCLICK KEY_F23	// Double Click		193(0xC1)
	#define KEY_CUST_SWIPEUP KEY_F24		// Swipe Up	194(0xC2)
	#define KEY_CUST_02 252
	#define KEY_CUST_03 253
	#define KEY_CUST_04 254
	#define KEY_CUST_C KEY_C		// C	46(0x2E)
	#define KEY_CUST_Z KEY_Z		// Z	44(0x2C)
	#define KEY_CUST_07 257
	#define KEY_CUST_08 258
	#define KEY_CUST_S KEY_S		// S	31(0x1F)
	#define KEY_CUST_V KEY_V		// V	47(0x2F)
	#define KEY_CUST_W KEY_W		// W	17(0x11)
	#define KEY_CUST_E KEY_E		// E	18(0x12)
	...
	#define HIMAX_PROC_GESTURE_FILE "goodix_gesture"
	static struct proc_dir_entry *himax_proc_GESTURE_file = NULL;
	static bool FAKE_POWER_KEY_SEND = false;
#endif

#define HIMAX_PROC_PSENSOR_FILE "psensor_state"
static struct proc_dir_entry *himax_proc_psensor_file = NULL;
static int psensor_state = 0;

#ifdef HX_HIGH_SENSE
//#include <linux/hall_sensor.h>
	#define HIMAX_PROC_HSEN_FILE "goodix_glove_switch"
...
static int key_range[3][4]={{140,240,1080,1280},{300,420,1080,1280},{480,600,1080,1280}};
#endif
